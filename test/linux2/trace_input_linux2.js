...
const target = "libark_jsruntime.so";
const taintStr = "flag{11111111111111111111111111111111}";
const traceOffset = 0x0007FC82942A957-0x0007FC827600000;
const logPath = "./";

const PrintMode = {ADDR: 0, BIN: 1, DEBUG: 2, TRACE: 3, TRITON: 4, TRACE_ARGS: 5,};
let talPath = {
    linux: "/sharedisk/qbdi/Release/linux/libtal.so",
...
let interval = setInterval(() => {
    ...
    trace(mod.base.add(traceOffset), ptr(0), 1, PrintMode.TRACE);
